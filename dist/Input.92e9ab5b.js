...
},{"strongly-typed-events":"../node_modules/strongly-typed-events/dist/index.js"}],"Handlers/MouseHandler.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function MouseHandler() {
    this.onMouseDown = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onMouseUp = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onMouseMove = new strongly_typed_events_1.SimpleEventDispatcher();
    this._buttons = new Map();
    this.addEventListners();
  }

  MouseHandler.prototype.addEventListners = function () {
  ...
  MouseHandler.prototype.doOnMouseDown = function (event) {
  ...
  MouseHandler.prototype.doOnMouseUp = function (event) {
    var button = event.which;
    if (!this._buttons.has(button)) return;
  ...
  MouseHandler.prototype.doOnMouseMove = function (event) {//console.log(event);
  };
...
},{"strongly-typed-events":"../node_modules/strongly-typed-events/dist/index.js"}],"../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../node_modules/buffer/index.js"}],"Handlers/TouchHandler.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function TouchHandler() {
    this.onTouchStart = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onFirstTouch = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onTouchEnd = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onLastTouch = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onTouchMove = new strongly_typed_events_1.SimpleEventDispatcher(); //private _touches: Touch[];

    this._touchMap = new Map();
    this._touchMapCache = new Map(); //this._touches = [];
  ...
  TouchHandler.prototype.getTouchCount = function () {
    return this._touchMap.size;
  };

  TouchHandler.prototype.getTouchList = function () {
    return lodash_1.default.cloneDeep(this._touchMap);
  };

  TouchHandler.prototype.addEventListners = function () {
  ...
  TouchHandler.prototype.doOnTouchEnd = function (event) {
    console.log(event);
  ...
  TouchHandler.prototype.doOnTouchMove = function (event) {
    for (var i = 0; i < event.changedTouches.length; i++) {
      var identifier = event.changedTouches[i].identifier;
  ...
  TouchHandler.prototype.CheckPinch = function () {
    var positions = [];

    this._touchMapCache.forEach(function (Element) {
      return positions.push(Element.clientX);
    });

    var currentDifference = Math.hypot(positions[0], positions[1]);
    console.log(currentDifference);

    if (this.previosDifference > 0) {
      if (currentDifference > this.previosDifference) {//console.log("zoom in")
      }

      if (currentDifference < this.previosDifference) {//console.log("zoom out")
      }
    }
...
},{"strongly-typed-events":"../node_modules/strongly-typed-events/dist/index.js","lodash":"../node_modules/lodash/lodash.js"}],"Handlers/ControllerEnum.ts":[function(require,module,exports) {
"use strict";
...
(function (JoySticks) {
  JoySticks[JoySticks["LeftStick"] = 0] = "LeftStick";
  JoySticks[JoySticks["RightStick"] = 1] = "RightStick";
})(JoySticks || (JoySticks = {}));

exports.JoySticks = JoySticks;
var ControllerButtons;

(function (ControllerButtons) {
  ControllerButtons[ControllerButtons["A"] = 0] = "A";
  ControllerButtons[ControllerButtons["B"] = 1] = "B";
  ControllerButtons[ControllerButtons["X"] = 2] = "X";
  ControllerButtons[ControllerButtons["Y"] = 3] = "Y";
  ControllerButtons[ControllerButtons["Cross"] = 0] = "Cross";
  ControllerButtons[ControllerButtons["Circle"] = 1] = "Circle";
  ControllerButtons[ControllerButtons["Square"] = 2] = "Square";
  ControllerButtons[ControllerButtons["Triangle"] = 3] = "Triangle";
  ControllerButtons[ControllerButtons["LeftBumper"] = 4] = "LeftBumper";
  ControllerButtons[ControllerButtons["RightBumper"] = 5] = "RightBumper";
  ControllerButtons[ControllerButtons["LeftTrigger"] = 6] = "LeftTrigger";
  ControllerButtons[ControllerButtons["RightTrigger"] = 7] = "RightTrigger";
  ControllerButtons[ControllerButtons["BackButton"] = 8] = "BackButton";
  ControllerButtons[ControllerButtons["StartButton"] = 9] = "StartButton";
  ControllerButtons[ControllerButtons["LeftStick"] = 10] = "LeftStick";
  ControllerButtons[ControllerButtons["RightStick"] = 11] = "RightStick";
  ControllerButtons[ControllerButtons["Up"] = 12] = "Up";
  ControllerButtons[ControllerButtons["Down"] = 13] = "Down";
  ControllerButtons[ControllerButtons["Left"] = 14] = "Left";
  ControllerButtons[ControllerButtons["Right"] = 15] = "Right";
})(ControllerButtons || (ControllerButtons = {}));

exports.ControllerButtons = ControllerButtons;
},{}],"Handlers/GamepadHandler.ts":[function(require,module,exports) {
"use strict";
...
var ControllerEnum_1 = require("./ControllerEnum");

var GamepadHandler =
/** @class */
function () {
  function GamepadHandler() {
    this.onGamepadConnected = new strongly_typed_events_1.SimpleEventDispatcher();
    this.onGamepadDisconnected = new strongly_typed_events_1.SimpleEventDispatcher();
    this.buttonsCache = new Map();
    this.buttonsStatus = new Map();
    this.axisStatus = new Map();
    this.leftJoystick = new Map();
    this.gamepads = [];
    this.addEventListners();
  }
  ...
  GamepadHandler.prototype.update = function () {
    ...
    var gamepads = navigator.getGamepads ? navigator.getGamepads() : []; //clear cacche

    this.buttonsCache.clear(); // move the buttons status from the previous frame to the cache

    this.buttonsStatus.forEach(function (value, key) {
      return _this.buttonsCache.set(key, value);
    }); //clear button status

    this.buttonsStatus.clear(); //temp map of all pressed buttons on every connected controller by index

    var pressed = new Map(); //loop trough all connected controllers and check if there actually is one

    for (var i = 0; i < gamepads.length; i++) {
      if (gamepads[i] != null) {
        // temp array to store all pressed buttons of a specifi controller
        var Buttons = []; //loop over all buttons on controller
  ...
  GamepadHandler.prototype.getConnectedGamepadsCount = function () {
    return this.gamepads.length;
  };

  GamepadHandler.prototype.getConnectedGamepads = function () {
    return lodash_1.default.cloneDeep(this.gamepads);
  };

  GamepadHandler.prototype.getButtonPressed = function (buttonIndex, controllerIndex, hold) {
    ...
    var newPress = false;
    var tempButtonStatus = this.buttonsStatus.get(controllerIndex);
    if (tempButtonStatus != undefined) newPress = tempButtonStatus[buttonIndex].pressed; //check for single press

    if (!hold) {
      var tempButtoncache = this.buttonsCache.get(controllerIndex);
      if (tempButtoncache != undefined) if (tempButtoncache[buttonIndex].pressed == true) newPress = false;
    }

    return newPress;
  };

  GamepadHandler.prototype.getButtonAxis = function (buttonIndex, controllerIndex) {
    var gamepads = navigator.getGamepads ? navigator.getGamepads() : [];
  ...
  GamepadHandler.prototype.getJoystickAxis = function (stick, controllerIndex) {
    var value = [];
    if (stick == ControllerEnum_1.JoySticks.LeftStick) value = this.leftJoystick.get(controllerIndex);
    if (stick == ControllerEnum_1.JoySticks.RightStick) value = this.leftJoystick.get(controllerIndex);
    return value;
  };

  GamepadHandler.prototype.getJoyAxis = function (buttonIndex, controllerIndex) {
    var gamepads = navigator.getGamepads ? navigator.getGamepads() : [];
    ...
    var axes = gp.axes[buttonIndex];
    return axes;
  };

  GamepadHandler.prototype.addEventListners = function () {
  ...
  GamepadHandler.prototype.updateConnectedGamepads = function (event, connecting) {
...
},{"strongly-typed-events":"../node_modules/strongly-typed-events/dist/index.js","lodash":"../node_modules/lodash/lodash.js","./ControllerEnum":"Handlers/ControllerEnum.ts"}],"Handlers/Input.ts":[function(require,module,exports) {
"use strict";
...
var KeyboardHandler_1 = __importDefault(require("./KeyboardHandler"));

var MouseHandler_1 = __importDefault(require("./MouseHandler"));

var TouchHandler_1 = __importDefault(require("./TouchHandler"));

var GamepadHandler_1 = __importDefault(require("./GamepadHandler"));
...
function () {
  ...
  Input.initialize = function () {
    Input.keyboard = new KeyboardHandler_1.default();
    Input.mouse = new MouseHandler_1.default();
    Input.touch = new TouchHandler_1.default();
    Input.gamepad = new GamepadHandler_1.default();
  };
...
},{"./KeyboardHandler":"Handlers/KeyboardHandler.ts","./MouseHandler":"Handlers/MouseHandler.ts","./TouchHandler":"Handlers/TouchHandler.ts","./GamepadHandler":"Handlers/GamepadHandler.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","Handlers/Input.ts"], null)
//# sourceMappingURL=/Input.92e9ab5b.js.map